...
def load():
    ...
    cfg["form"] = {"filter_dir": os.path.expanduser("~/Documents")+"/My Games/Path of Exile/",
                   ...
                   "sets_goal":"4",
                #    "color_weapon":"#00ffff",
                   "color_weapon_rgb":"["+BASE_RGB+", 235]",
                #    "color_helmet":"#00ffff",
                   "color_helmet_rgb":"["+BASE_RGB+", 210]",
                #    "color_gloves":"#00ffff",
                   "color_gloves_rgb":"["+BASE_RGB+", 210]",
                #    "color_ring":"#00ffff",
                   "color_ring_rgb":"["+BASE_RGB+", 255]",
                #    "color_amulet":"#00ffff",
                   "color_amulet_rgb":"["+BASE_RGB+", 255]",
                #    "color_body_armour":"#00ffff",
                   "color_body_armour_rgb":"["+BASE_RGB+", 150]",
                #    "color_boots":"#00ffff",
                   "color_boots_rgb":"["+BASE_RGB+", 210]",
                #    "color_belt":"#00ffff",
                   "color_belt_rgb":"["+BASE_RGB+", 235]",                   
                   }
